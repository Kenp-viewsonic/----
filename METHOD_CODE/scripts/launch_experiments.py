...
SCENARIOS = {
    ...
    "full_experiment_low_rank_hardneg_pc": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_hardneg_pc.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G1: Per-class confusion hard negatives from co-occurring old classes",
    },
    "full_experiment_low_rank_margin": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_margin.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G2: Logit-level margin pushing new-class logits above old-class max",
    },
    "full_experiment_low_rank_delaykd": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_delaykd.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G2: Skip KD for first 40% of stage1 steps",
    },
    "full_experiment_low_rank_lrboost": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_lrboost.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G2: 2.5x LR boost for classifier new rows + plastic branch",
    },
    "full_experiment_low_rank_stable2": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_stable2.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G3: Unfreeze top-2 stable layers during stage1",
    },
    "full_experiment_low_rank_noprefix_diag": {
        "config": "configs/full_experiment_low_rank_noprefix_diag.yaml",
        "stages_config": "configs/full_stages_low_rank_noprefix_diag.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G3: Diagnostic — disable prefix anchoring entirely for stage1",
    },
    "full_experiment_low_rank_rp8": {
        "config": "configs/full_experiment_low_rank_rp8.yaml",
        "stages_config": "configs/full_stages_low_rank_rp8.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G4: Capacity test — plastic rank=8 on low_rank baseline",
    },
    "full_experiment_low_rank_combo_hm": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_combo_hm.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G4: Combo — hardneg_perclass + class_margin",
    },
    "full_experiment_low_rank_combo_hd": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_combo_hd.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G4: Combo — hardneg_perclass + delayed_kd",
    },
    "full_experiment_low_rank_combo_hs": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_combo_hs.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G4: Combo — hardneg_perclass + stable_top2",
    },
    "full_experiment_low_rank_combo_triple": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_combo_triple.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
        "description": "G4: Combo triple — hardneg + margin + delaykd",
    },
    "full_experiment_low_rank_combo_quad": {
        "config": "configs/full_experiment_low_rank.yaml",
        "stages_config": "configs/full_stages_low_rank_combo_quad.yaml",
        "default_seeds": [42],
        "default_methods": ["ours"],
